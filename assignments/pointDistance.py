...
distance = 6371.01 * math.acos((math.sin(latitude_one) * math.sin(latitude_two)) + math.cos(latitude_one) * (math.cos(latitude_two) * math.cos(longitude_one - longitude_two)) )
